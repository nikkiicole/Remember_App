  ...
  return (
    ...
    <div className="container">
      {/* need to replace second half with real website to see if it is working  */}
        ...
        <select className="input-select" id="backgroundImage" required onChange={handleInput} value = "design">
        <option value = "white-bg-flowers" >White Background White Flowers</option>
              <option value="blue-flowers">Blue Background With Flowers </option>
              <option value="white-pink-flowers">White Background Pink Flowers </option>
              <option value="white-flowers">White Flower Background </option>
              <option value="pink-white-stripe">Pink And White Striped Background </option>
              <option value="wood-flowers"default>Wood Background Flower Header </option>
              <option value="white-leaf">White Background Green Leaf Header </option>
              <option value="green-tree">Green Background Tree Design </option>
              <option value="wood-pink-flowers">Wood Background Pink Flower Header </option>
              <option value="white-fall">White Background Fall Leaf Header </option>
              <option value="yellow-flowers">Yellow Background White Flower Footer</option>
      ...
      <a href={`https://www.facebook.com/share.php?u=https://always-remember.netlify.app/user-home/${id}`}><img src="https://res.cloudinary.com/dbmxg3su8/image/upload/v1620875227/Screen_Shot_2021-05-12_at_11.05.53_PM_yo0kb2.png" alt= "facebook logo" border="0" /></a>
